...
# tcemc
export LD_LIBRARY_PATH=/usr/local/stow/llvm-5.0/lib:$LD_LIBRARY_PATH
export PATH=/usr/local/stow/llvm-5.0/bin:$PATH
...
# autcompletion tce_polar/tools.py
...
# System C
export SYSTEMC_HOME=/opt/systemc232
